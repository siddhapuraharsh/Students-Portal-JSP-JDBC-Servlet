...
<style>
body{
background-image: url(/StudentRegistrationSystem/images/homepage.jpeg);
...
<body>
<div class="header">
<a href='/StudentRegistrationSystem/InvalidateSession' id="logout" title="Log out"><img alt="" src="images/log_off.png" width="100" height="100" border="0" style="float:right;" ></a>
<h1>
