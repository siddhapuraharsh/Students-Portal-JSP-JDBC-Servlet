...
<html>
<head>
    <title>modify | Student information management system</title>
    <style>
...
<body bgcolor="beige">
    <div class="header">Modify student information</div>
    <form action="${pageContext.request.contextPath}/updateServlet" method="post" name="updateForm">
        <table width="400px" align="center" border="1" cellspacing="0">
            <tr>
                <td>number(Not modifiable): </td>
